...
export const websiteData = [
  ...
  },
  {
    id: 20,
    name: "Freepik",
    description: "超过百万免费矢量、PSD、照片和图标",
...
// 分类定义 - 基于 WebStack.cc 的分类结构，支持二级分类
...
export const searchEngines = [
  { id: "internal", name: "站内搜索", url: "", color: "bg-blue-600" }
];
...
export const siteStats = {
  ...
  popularSites: websiteData.filter(site => site.popularity >= 90).length,
